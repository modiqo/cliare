...
impl GuardSummary {
    pub fn terminal_summary(&self) -> String {
        ...
        let mut lines = vec![
            ...
            format!("  baseline score: {:.0}", self.baseline_total),
            format!("  current score: {:.0}", self.current_total),
    ...
    fn measurement_summary(score_total: f64) -> MeasurementSummary {
        MeasurementSummary {
            ...
            facts: crate::measure::MeasurementFacts {
                ...
                help_text_probes: 0,
                help_text_probes_with_shape: 0,
                help_text_probes_without_shape: 0,
                help_text_probes_not_recognized: 0,
                parser_extraction_rate: 0.0,
